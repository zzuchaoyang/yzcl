(function($){
    ...
    $('body').append('<style>'+
                ...
                '.sel-boxs .bg{position:fixed;left:0;top:0;right:0;bottom:0;background:rgba(0,0,0,.5);z-index:999;}'+
                '.sel-box{position:fixed;bottom:0;left:0;right:0;z-index:999;}'+
                '.sel-box .btn{background:#f5f5f5;overflow:hidden;}'+
                '.sel-box .btn1{overflow:hidden;width:28px;font-size: 14px;height:22px;float:left;padding:11px 12px;    color: #333;}'+
                '.sel-box .btn1 img{float:left;width:100%;height:100%;}'+
                '.sel-box .ok{float:right;color: #00B38B}'+
                '.sel-box .name{color:#333;text-align:center;line-height:22px;font-size:14px;padding:11px 0;}'+
                '.sel-con{background:white;}'+
                '.sel-con .border{height:34px;border:solid 1px #eee;border-width:1px 0;position:fixed;bottom:72px;left:0;right:0;pointer-events:none;}'+
                ...
                '.select-active {color: #333!important;}' +
                '.ele {overflow: hidden;white-space: nowrap;text-overflow: ellipsis;overflow: hidden;text-overflow:ellipsis;}' +
                '</style>'+
                '<div class="sel-boxs">'+
                '   <div class="bg"></div>'+
    ...
    $.scrEvent = function(params){
        ...
        $(evEle).on(type, function (){
            ...
            $('.sel-con .scroll').scroll(function(){
                ...
                $(this).find('.ele').eq(scNum).addClass('select-active').siblings().removeClass('select-active')
                // 停止锁定
