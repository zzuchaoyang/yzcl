...
(function (h, f) {
        ...
        util: {
            ...
            addIcon: function (s, p) {
                ...
                if (r) {
                    ...
                    m(q, p);
                    u.addClass((q.right ? "mbsc-ic-right " : "") + (q.left ? " mbsc-ic-left" : "")).find(
                        ".mbsc-input-wrap").append(q.left ?
                        '<span class="mbsc-input-ic mbsc-left-ic mbsc-ic mbsc-ic-' + q.left +
                        '"></span>' : "").append(q.right ?
                        '<span class="mbsc-input-ic mbsc-right-ic mbsc-ic mbsc-ic-' + q.right +
                        '"></span>' : "")
                }
            },
    ...
    h.mobiscroll.classes.Base = function (t, u) {
        ...
        z.tap = function (D, L, I) {
            ...
            if (B.tap) {
                D.on("touchstart.dw pointerdown.dw", K).on("touchcancel.dw pointercancel.dw", J).on(
                    "touchmove.dw", C).on("touchend.dw", s)
            }
...
(function (i, n, o, h) {
    ...
    c.classes.Frame = function (ae, af, B) {
        ...
        V.show = function (aj, s) {
            ...
            ak = '<div lang="' + aa.lang + '" class="mbsc-' + aa.theme + (aa.baseTheme ? " mbsc-" + aa.baseTheme :
                    "") + " dw-" + aa.display + " " + (aa.cssClass || "") + (V._isLiquid ? " dw-liq" : "") +
                (q ? " mbsc-old" : "") + (E ? "" : " dw-nobtn") + '"><div class="dw-persp">' + (X ?
                    '<div class="dwo"></div>' : "") + "<div" + (X ? ' role="dialog" tabindex="-1"' : "") +
                ' class="dw' + (aa.rtl ? " dw-rtl" : " dw-ltr") + '">' + (aa.display === "bubble" ?
                    '<div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div>' :
                    "") + '<div class="dwwr"><div aria-live="assertive" class="dw-aria dw-hidden"></div>' +
                (aa.headerText ? '<div class="dwv">' + (d(aa.headerText) ? aa.headerText : "") + "</div>" :
                    "") + '<div class="dwcc">';
            ak += V._generateContent();
            ak += "</div>";
            if (E) {
                ak += '<div class="dwbc">' + '<p style="display: inline-block; line-height: 40px; color: #333; font-size: .85rem">选择日期</p>';
                i.each(L, function (am, al) {
                    ...
                    ak += "<div" + (aa.btnWidth ? ' style="width:' + (100 / L.length) + '%"' : "") +
                        ' class="dwbw ' + (al.parentClass || "") +
                        '"><div tabindex="0" role="button" class="dwb' + am + " dwb-e " + (al.cssClass ===
                            h ? aa.btnClass : al.cssClass) + (al.icon ? " mbsc-ic mbsc-ic-" + al.icon :
                            "") + '">' + (al.text || "") + "</div></div>"
                });
                ak += "</div>"
            }
        ...
        V.hide = function (s, aj, ak, al) {
            if (!V._isVisible || (!ak && !V._isValid && aj == "set") || (!ak && ai("onBeforeClose", [V._tempValue,
                    aj
                ]) === false)) {
                return false
            }
    ...
    g.Scroller = function (aj, al, F) {
        ...
        function J(aq) {
            ...
            h.each(ao, function (av, au) {
                ...
                ap += '<div role="option" aria-selected="false" class="dw-li dw-v" data-val="' + ar[av] +
                    '"' + (at[av] ? ' aria-label="' + at[av] + '"' : "") + ' style="height:' + am +
                    "px;line-height:" + am + 'px;"><div class="dw-i"' + (X > 1 ? ' style="line-height:' +
                        Math.round(am / X) + "px;font-size:" + Math.round(am / X * 0.8) + 'px;"' : "") +
                    ">" + au + "</div></div>";
                p++
            });
            ap += "</div>";
        ...
        function t(p) {
            ...
            M = Math.max(an, h(".dw-li", p).index(h(Z ? ".dw-li" : ".dw-v", p).eq(-1)) - (Z ? ae.rows - (ae.mode ==
                "scroller" ? 1 : 3) : 0));
        ...
        ac._generateContent = function () {
            ...
            h.each(ae.wheels, function (aq, ap) {
                s += '<div class="mbsc-w-p dwc' + (ae.mode != "scroller" ? " dwpm" : " dwsc") + (ae
                    .showLabel ? "" : " dwhl") + '"><div class="dwwc"' + (ae.maxWidth ? "" :
                ...
                h.each(ap, function (at, ar) {
                    ...
                    s += "<" + (a ? "div" : "td") + ' class="dwfl" style="' + (ae.fixedWidth ?
                            ("width:" + (ae.fixedWidth[p] || ae.fixedWidth) + "px;") : (ae.minWidth ?
                                ("min-width:" + (ae.minWidth[p] || ae.minWidth) + "px;") :
                                "min-width:" + ae.width + "px;") + (ae.maxWidth ? (
                                    "max-width:" + (ae.maxWidth[p] || ae.maxWidth) + "px;") :
                                "")) + '"><div class="dwwl dwwl' + p + (ar.multiple ?
                            " dwwms" : "") + '">' + (ae.mode != "scroller" ?
                            '<div class="dwb-e dwwb dwwbp ' + (ae.btnPlusClass || "") +
                            '" style="height:' + am + "px;line-height:" + am +
                            'px;"><span>+</span></div><div class="dwb-e dwwb dwwbm ' + (ae.btnMinusClass ||
                                "") + '" style="height:' + am + "px;line-height:" + am +
                            'px;"><span>&ndash;</span></div>' : "") + '<div class="dwl">' +
                        ao + '</div><div tabindex="0" aria-live="off" aria-label="' + ao +
                        '" role="listbox" class="dwww"><div class="dww" style="height:' + (
                            ae.rows * am) + 'px;"><div class="dw-ul" style="margin-top:' +
                        (ar.multiple ? (ae.mode == "scroller" ? 0 : am) : ae.rows / 2 * am -
                            am / 2) + 'px;">';
                    s += J(p) +
                        '</div></div><div class="dwwo"></div></div><div class="dwwol"' + (
                            ae.selectedLineHeight ? ' style="height:' + am +
                            "px;margin-top:-" + (am / 2 + (ae.selectedLineBorder || 0)) +
                            'px;"' : "") + "></div></div>" + (a ? "</div>" : "</td>");
                    p++
                });
        ...
        ac._attachEvents = function (p) {
            p.on("keydown", ".dwwl", A).on("keyup", ".dwwl", q).on("touchstart mousedown", ".dwwl", E).on(
                "touchmove", ".dwwl", H).on("touchend", ".dwwl", ah).on("touchstart mousedown", ".dwwb",
                K).on("touchend touchcancel", ".dwwb", N);
            if (ae.mousewheel) {
        ...
        ac._readValue = function () {
            ...
            ac._tempWheelArray = ac._hasValue && ac._wheelArray ? ac._wheelArray.slice(0) : ae.parseValue.call(
                aj, p, ac) || [];
            Y()
        };
        ac._processSettings = function () {
            ...
            am = ae.height;
            X = ae.multiline;
            ac._isLiquid = (ae.layout || (/top|bottom/.test(ae.display) && ae.wheels.length == 1 ? "liquid" :
                "")) === "liquid";
            if (ae.formatResult) {
...
(function (b, c) {
    ...
    a.datetime = {
                ...
                if (o) {
                    ...
                    switch (p.charAt(k)) {
                        ...
                        case "D":
                            ...
                            break;
                        case "o":
                            d += j("o", (e.getTime() - new Date(e.getFullYear(), 0, 0).getTime()) /
                                86400000, 3);
                            break;
                        case "m":
        ...
        parseDate: function (v, n, x) {
            ...
            if (f < 100) {
                f += new Date().getFullYear() - new Date().getFullYear() % 100 + (f <= (typeof d !=
                    "string" ? d : new Date().getFullYear() % 100 + parseInt(d, 10)) ? 0 : -100)
            }
            if (i > -1) {
                z = 1;
                t = i;
                ...
                for (W = 0; W < 3; W++) {
                    if (W == T.y) {
                        ...
                        if (W == T.m) {
                            ...
                            P = [];
                            for (X = 0; X < 12; X++) {
                                var aF = l.replace(/[dy]/gi, "").replace(/mm/, (X < 9 ? "0" + (X + 1) : X + 1) + (Q
                                    .monthSuffix || "")).replace(/m/, X + 1 + (Q.monthSuffix || ""));
                                P.push(X);
                                B.push(aF.match(/MM/) ? aF.replace(/MM/, '<span class="dw-mon">' + Q.monthNames[X] +
                                    "</span>") : aF.replace(/M/, '<span class="dw-mon">' + Q.monthNamesShort[
                                    X] + "</span>"))
                            }
                            x(q, P, B, Q.monthText)
                        } else {
                        ...
                        if (W == T.i) {
                            ...
                            if (W == T.s) {
                                ...
                                if (W == T.a) {
                                    r++;
                                    var K = ac.match(/A/);
                                    x(q, [0, 1], K ? [Q.amText.toUpperCase(), Q.pmText.toUpperCase()] : [Q.amText,
                                        Q.pmText
                                    ], Q.ampmText)
                                }
                            }
            ...
            function V(s, p) {
                ...
                if (p) {
                    for (k = 0; k < p.length; k++) {
                        ...
                        if (!o.start) {
                            if (o.getTime) {
                                if (s.getFullYear() == o.getFullYear() && s.getMonth() == o.getMonth() && s.getDate() ==
                                    o.getDate()) {
                                    return true
                                }
                            } else {
                ...
                if (k) {
                    d.each(k, function (a8, a9) {
                        if (a9.start) {
                            ...
                            aT = a5 + "";
                            aQ = aT.split("/");
                            if (a5 && ((a5.getTime && aI == Q.getYear(a5) && aR == Q.getMonth(a5) && a4 ==
                                    Q.getDay(a5)) || (!aT.match(/w/i) && ((aQ[1] && a4 == aQ[1] && aR ==
                                    aQ[0] - 1) || (!aQ[1] && a4 == aQ[0]))) || (aT.match(/w/i) && aV.getDay() ==
                                    +aT.replace("w", "")))) {
                                a9.apply = true;
                                aH[aV] = true
                            }
                                ...
                                if (aD) {
                                    d(".dw-li", aX).each(function () {
                                        var aY = d(this),
                                            ...
                                            aZ = l.replace(/[my]/gi, "").replace(/dd/, (a0 < 10 ?
                                                "0" + a0 : a0) + (Q.daySuffix || "")).replace(
                                                /d/, a0 + (Q.daySuffix || ""));
                                        d(".dw-i", aY).html(aZ.match(/DD/) ? aZ.replace(/DD/,
                                            '<span class="dw-day">' + Q.dayNames[i] +
                                            "</span>") : aZ.replace(/D/,
                                            '<span class="dw-day">' + Q.dayNamesShort[i] +
                                            "</span>"))
                                    })
                                }
                            }
...
(function (d, f) {
    ...
    c.presets.scroller.select = function (M) {
        ...
        if (ag.next().is("input.mbsc-control")) {
            ...
            k = d('<input type="text" id="' + S + '" class="mbsc-control mbsc-control-ev ' + W.inputClass +
                '" />');
            if (W.showInput) {
                k.insertBefore(ag)
            }
        ...
        return {
            ...
            onBeforeShow: function () {
                if (Q && W.counter) {
                    W.headerText = function () {
                        ...
                        return (i > 1 ? W.selectedPluralText || W.selectedText : W.selectedText).replace(
                            /{count}/, i)
                    }
                }
                r(ag.val());
            ...
            validate: function (al, aq, am, an) {
                ...
                if (aq === f && Q) {
                    ...
                    for (ao in av) {
                        d(".dwwl" + q + ' .dw-li[data-val="' + av[ao] + '"]', al).addClass(u).attr(
                            "aria-selected", "true")
                    }
                }
                if (B) {
