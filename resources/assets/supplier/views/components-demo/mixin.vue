...
<script>
import PanThumb from '@common/components/PanThumb'
import MdInput from '@common/components/MDinput'
import Mallki from '@common/components/TextHoverEffect/Mallki'
import DropdownMenu from '@common/components/Share/dropdownMenu'
import waves from '@supplier/directive/waves/index.js' // 水波纹指令
