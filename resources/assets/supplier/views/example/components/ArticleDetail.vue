...
import Upload from '@common/components/Upload/singleImage3'
import MDinput from '@common/components/MDinput'
import Multiselect from 'vue-multiselect'// 使用的一个多选框组件，element-ui的select不能满足所有需求
import 'vue-multiselect/dist/vue-multiselect.min.css'// 多选框组件css
import Sticky from '@common/components/Sticky' // 粘性header组件
import { validateURL } from '@common/utils/validate'
import { fetchArticle } from '@supplier/api/article'
import { userSearch } from '@supplier/api/remoteSearch'
