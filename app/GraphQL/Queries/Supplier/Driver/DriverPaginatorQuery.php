...
class DriverPaginatorQuery extends BaseQuery
{

    protected $attributes = [
        'name'        => 'driverPaginator',
        'description' => '供应商司机列表',
    ];

    public function type()
    {
        return GraphQL::pagination(GraphQL::type('Driver'));
    }
    ...
    {
        return Driver::getGraphQLPaginator($this->getConditions($args), $info);
    }
}
